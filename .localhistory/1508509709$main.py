...
plt.plot(np.arange(1900, 2000),Y_train)
plt.plot(np.arange(1900, 2000),Y_test[0])
plt.plot(np.arange(1900, 2000),Y_test[1])
plt.plot(np.arange(1900, 2000),Y_test[2])
plt.plot(np.arange(1900, 2000),Y_test[0]*fitParams[0] + Y_test[1]*fitParams[1] + Y_test[2]*fitParams[2])
