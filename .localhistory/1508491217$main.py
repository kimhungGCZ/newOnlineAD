...
X = np.arange(0,len(raw_data) - 20 - last_change_point)
Y = raw_data[last_change_point:len(raw_data) - 20]
...
print("Ridge model:{} + {}".format(pretty_print_linear(ridge.coef_),ridge.intercept_))
...
print("Start prediction for point {}th:".format(len(raw_data) - 19)
