...
from sklearn import linear_model_sk
...
print("Params: {}".format(linear_model.params))
print("R-squared: {}".format(linear_model.rsquared))
########################### Online building model ############################
clf = linear_model_sk.SGDClassifier()
clf.fit(X, Y)
Y_new_2 = clf.predict(X_new)

plt.plot(X_new,Y_new_2)
